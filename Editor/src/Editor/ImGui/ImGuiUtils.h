...
bool Property(const std::string& label, int& value, int min = -1, int max = 1);

bool Property(const std::string& label, float& value, float min = -1.0f, float max = 1.0f);
bool Property(const std::string& label, glm::vec2& value, float min = -1.0f, float max = 1.0f);

bool Property(const std::string& label, glm::vec3& value, float min = -1.0f, float max = 1.0f);
bool Property(const std::string& label, glm::vec3& value, PropertyFlags flags);

bool Property(const std::string& label, glm::vec4& value, float min = -1.0f, float max = 1.0f);
