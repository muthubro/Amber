...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
...

	{
		...
		Hazel::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, glm::radians(30.0f), { 0.2f, 0.3f, 0.8f, 1.0f });
		Hazel::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 20.0f, 20.0f }, 0.0f, m_CheckerboardTexture, 10.0f);
		Hazel::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, glm::radians(rotation), m_CheckerboardTexture, 20.0f, {
			{ 1.0f, 0.6f, 0.3f, 1.0f },
			{ 0.6f, 0.3f, 0.0f, 1.0f },
			{ 0.3f, 0.0f, 1.0f, 1.0f },
			{ 0.0f, 1.0f, 0.6f, 1.0f },
