...
public:
    ...
    virtual void CopyTo(Ref<Texture2D> dst) = 0;
    ...
    static Ref<Texture2D> Create(const std::string& path, bool srgb = false, bool flip = true, TextureWrap wrap = TextureWrap::Clamp, TextureFilter filter = TextureFilter::Linear);
