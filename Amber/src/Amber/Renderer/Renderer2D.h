...
namespace Amber
{
    ...
    public:
        ...
        static void DrawQuad(const glm::vec2& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, const Texture2DBounds& texBounds, float tilingFactor = 1.0f);
        static void DrawQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, const Texture2DBounds& texBounds, float tilingFactor = 1.0f);
        ...
        static void DrawQuad(const glm::vec2& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, const Texture2DBounds& texBounds, const glm::vec4& color, float tilingFactor = 1.0f);
        static void DrawQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, const Texture2DBounds& texBounds, const glm::vec4& color, float tilingFactor = 1.0f);
        ...
        static void DrawQuad(const glm::vec2& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, const Texture2DBounds& texBounds, const glm::mat4& color, float tilingFactor = 1.0f);
        static void DrawQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const Ref<Texture2D>& texture, const Texture2DBounds& texBounds, const glm::mat4& color, float tilingFactor = 1.0f);
